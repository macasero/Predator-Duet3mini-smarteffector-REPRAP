...
;var Probe_Temp = {global.nozzleProbeTemperature}                                                           ; The temperature you wish the nozzle to have while probing
var Tolerance = 5                                                              ; Probing will start at this amount of degrees ABOVE global.nozzleProbeTemperature (if the hotend is already cooling down)
...
var Max_Temp = {global.nozzleProbeTemperature + var.Tolerance}                               ; Calculate var.Max_Temp
...
if var.Target_Temp > global.nozzleProbeTemperature && global.TAPPING = false
  var msg = "Extruder temperature target of " ^ var.Target_Temp ^ "°C is too high, lowering to " ^ global.nozzleProbeTemperature ^ "°C"
  M291 P{var.msg} T4
  set global.TAPPING  = true
  G10 P0 S{global.nozzleProbeTemperature}                                                   ; Set hotend temperature to var.Probe_Temp
...
if var.Target_Temp < global.nozzleProbeTemperature && global.TAPPING = false
  var msg = "Extruder temperature " ^ var.Actual_Temp ^ "°C is still too low, waiting until hotend reaches probing temp of " ^ global.nozzleProbeTemperature  ^ "°C"
  M291 P{var.msg} T4
  set global.TAPPING  = true
  G10 P0 S{global.nozzleProbeTemperature}                                                   ; Set hotend temperature to var.Probe_temp
  M116 H1 S{var.Tolerance}                                                   ; Wait for the hotend to reach var.Max_Temp  